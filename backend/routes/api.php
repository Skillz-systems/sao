...
Route::get('paymentrequestmeshgrid/{id}', [PaymentController::class,'getMeshgridProjectDetails']);
Route::post('confirmpayment/{id}/{projectid}', [PaymentController::class,'confirmPayment']);
Route::post('confirmpaymentmeshgrid/{id}/{projectid}', [PaymentController::class,'confirmPaymentMeshgrid']);
...
Route::middleware('auth:sanctum')->group( function () {
    ...
    Route::post('link-meshgrid-to-project/{projectid}', [ProjectController::class, 'linkMeshgridToProject']);
    ...
    Route::get('fetch-project-meshgrid/{id}', [ProjectController::class, 'fetchProjectMeshgrid']);
    Route::get('get-meshgrid-with-projectid/{id}', [ProjectController::class, 'getMeshgridWithProjectid']);
    Route::get('site', [SiteController::class, 'index']);
    Route::post('create-meshgrid-connections', [ProjectController::class, 'createMeshgridConnections']);
...
Route::get('paymentperyear', [SiteController::class, 'paymentPerYear']);
Route::post('backdoorpaymentmeshgrid/{id}', [ProjectController::class, 'backdoorPaymentMeshgrid']);
